package laoyou.com.laoyou.tencent.presentation.business;
...
import laoyou.com.laoyou.tencent.utils.Constant;
...
public class LoginBusiness {
    ...
    public static void loginIm(String identify, String userSig, TIMCallBack callBack){
        ...
        Log.i(TAG, "UserInfo id ====" + identify);
        Log.i(TAG, "UserInfo Sig ====" + userSig);
