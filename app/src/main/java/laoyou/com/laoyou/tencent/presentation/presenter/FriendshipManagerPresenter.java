...
import static laoyou.com.laoyou.tencent.presentation.presenter.GroupInfoPresenter.getCode;
...
public class FriendshipManagerPresenter {
     ...
     * @param callBack 回调
     */
    public static void setHeadImg(String url, TIMCallBack callBack) {
