...
//        LoginBusiness.loginIm("admin", "eJxlj1FPgzAYRd-5FYRXjWtZi2Liw0ZASzCZc3ThiXRQ5ieBdVAJsvjfnbhEEu-rOTc392SYpmltotcbkWWHj1qn*lNJy7w3LWRd-0GlIE*FTudN-g-KXkEjU1Fo2YwQU0pthKYO5LLWUMDFEHkF9QS3eZmOG799ci4Tl1AyVWA-wmc-9pi3DHe9*86dIS73T0m8PnZ*Ae1WsU3H6IrypNwFwaNqXb4Af1GqFb8SQ1hlynPYXcS9bSJmqD*yt9soDNeFG86WL0OgWv9hMqmhkpdDGGNCsEMntJNNC4d6FGx0Vuw5*ollfBnfN0tdEQ__", this);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (LOGIN_RESULT_CODE == requestCode) {
            ...
            if (0 == TLSService.getInstance().getLastErrno()) {
                ...
                Log.i(TAG, " userSig ===" + UserInfo.getInstance().getUserSig());
                navToHome();
