...
import laoyou.com.laoyou.tencent.model.FileMessage;
...
import laoyou.com.laoyou.tencent.model.ImageMessage;
...
public class ChatActivity extends FragmentActivity implements ChatView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ChatAdapter(this, R.layout.item_message, messageList,type);
                ...
                if (FriendshipInfo.getInstance().isFriend(identify)){
                    ...
                    title.setMoreImgAction(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            person.putExtra("head_img", SPreferences.getTemporaryImg());
