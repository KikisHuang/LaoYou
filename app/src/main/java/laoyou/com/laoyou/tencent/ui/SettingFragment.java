...
public class SettingFragment extends Fragment implements FriendInfoView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (view == null) {
            ...
            Toast.makeText(getActivity(), getString(TIMManager.getInstance().getEnv() == 0 ? R.string.env_normal : R.string.env_test), Toast.LENGTH_SHORT).show();
    ...
    public void showUserInfo(List<TIMUserProfile> users) {
        ...
        setHeadImg(users.get(0).getFaceUrl());
