package laoyou.com.laoyou.overlay;
...
import laoyou.com.laoyou.utils.map.AMapUtil;
...
public class DrivingRouteOverlay extends RouteOverlay{
    ...
    private int getcolor(String status) {
    	...
    	if (status.equals("畅通")) {
            return Color.parseColor("#48B267");
		} else if (status.equals("缓行")) {
            return Color.parseColor("#edcf2a");
		} else if (status.equals("拥堵")) {
            return Color.parseColor("#c62f34");
