package laoyou.com.laoyou.view.group;
...
public class GroupCircularImageView extends View {
    ...
    public GroupCircularImageView(Context context) {
        super(context);
    }

    public GroupCircularImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public GroupCircularImageView(Context context, AttributeSet attrs, int defStyle) {
